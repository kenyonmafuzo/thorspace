export default {
  ...
  vip: {
    ...
    customizationTitle: "VIP Customization",
    previewLabel: "LIVE PREVIEW",
    nameColorLabel: "NAME COLOR",
    avatarLabel: "PROFILE PICTURE",
    avatarHint: "Exclusive VIP avatars coming soon. Save to apply.",
    frameColorLabel: "FRAME / BORDER COLOR",
    saveCustomization: "SAVE CUSTOMIZATION",
    saving: "Saving...",
    saveError: "Error saving",
    saveSuccess: "Saved!",
    activatedTitle: "ACTIVATED!",
    activatedMsg: "Welcome to the exclusive club. Enjoy all the benefits!",
    activatedStart: "Start:",
    activatedExpires: "Expires:",
    activatedBtn: "⚡ LET'S GO!",
    errorNotLoggedIn: "You must be logged in to continue.",
    errorPix: "Error generating PIX. Please try again.",
    errorPayment: "Error starting payment. Please try again.",
