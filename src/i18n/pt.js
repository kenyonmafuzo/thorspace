export default {
  ...
  vip: {
    ...
    customizationTitle: "Personalização VIP",
    previewLabel: "PRÉVIA AO VIVO",
    nameColorLabel: "COR DO NOME",
    avatarLabel: "IMAGEM DO PERFIL",
    avatarHint: "Avatares VIP exclusivos chegando em breve. Salve para aplicar.",
    frameColorLabel: "COR DO FRAME / BORDA",
    saveCustomization: "SALVAR PERSONALIZAÇÃO",
    saving: "Salvando...",
    saveError: "Erro ao salvar",
    saveSuccess: "Salvo!",
    activatedTitle: "ATIVADO!",
    activatedMsg: "Bem-vindo ao clube exclusivo. Aproveite todos os benefícios!",
    activatedStart: "Início:",
    activatedExpires: "Expira:",
    activatedBtn: "⚡ APROVEITAR!",
    errorNotLoggedIn: "Você precisa estar logado para continuar.",
    errorPix: "Erro ao gerar PIX. Tente novamente.",
    errorPayment: "Erro ao iniciar pagamento. Tente novamente.",
